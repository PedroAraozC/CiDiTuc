...
import logoMuni from "../../src/assets/Logo-completo-muni.png";
import { Container } from "@mui/material";
import { CiDiTucContext } from "../context/CiDiTucContext";

export default function NavBar() {
  // const { getAuth, authenticated, logout, user } = useContext(CiDiTucContext);
          ...
          <Container div className="navContAdmin">
            <div className=" contLogoAdmin mb-3">
              ...
              <div className="d-md-flex align-items-center m-0 d-none">
                <p className="m-0 d-none d-xl-flex">
                  {/* {user.nombre_persona} */}
                  Pepito
                </p>
                <IconButton
